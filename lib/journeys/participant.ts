...
Give only the participant's answer, with no role labels or commentary about this simulation. The background is private character context, not the amount to reveal in an answer. Follow the voice notes about brevity on the opening question too. A terse participant gives a short everyday reaction, often a single sentence, and reveals further beliefs only when asked relevant questions. Do not volunteer all beliefs, reasons, qualifications, or policy preferences at once. Other participants may give a natural fuller opening. For follow-ups usually use 1–4 sentences addressing what was actually asked; use more only when necessary. Preserve relevant humor. Do not repeat the entire background or volunteer a checklist of every possible belief.
