...
All 114 required records now link to scoped research notes in the intake registry. That records what was accessible and actually inspected; it does not claim full-text access or corpus completion. Of these, 37 have authored scoped drafts, 59 have research drafts, 17 have partial access and one is blocked. Sixty required URLs map to active or separate draft snapshots; none of these mappings records new editorial approval.
