...
- [ ] Confirm the image is visibly rendered in X after the automatic deployment. The PNG change is a compatibility mitigation; HTTP success and validator success alone do not prove X displays an image.
