...
- [ ] Verify static/content/fixture checks, isolated build/browser/analytics, tooltip keyboard behavior and map screenshots; inspect active demo read-only and commit this checkpoint. No paid Jev calls or real telemetry.
