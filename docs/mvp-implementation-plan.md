...
### 2026-09-19 — Evidence quality and uncertainty follow-through / Codex

- [x] Preserve earlier supported evidence after weak later mentions, and clear old ambiguity only when Jev judges it resolved. Make qualified and explicitly unknown claims correctable. Record explicit timing uncertainty for routing. Checkpoint: `dcc4584`.
- [x] Reproduce and fix obsolete timing context after a later unknown answer, and retain supported catastrophic-risk uncertainty in the result and clarification path.
- [x] Use saved live text to diagnose missing-versus-poor-reasoning confusion. Clarify evidence-presence instructions and verify both explicit dismissal and a missing-evidence control with live Jev.
...
### 2026-09-19 — Control novelty and visible partial results / Codex

- [x] Apply the existing repetition penalty across control-test and control-method questions, without excluding either; verify the exact saved labor decision with live Jev.
...
- [x] Recheck formatting, lint, types, all 194 unit tests, content validation and eight journey/map browser tests after live extraction refinements. Inspect the populated fixed-user journey and answer switching in Chrome.
...
### 2026-09-22 — Result navigation and chart clarity

- [x] Move result-map actions to the card header; keep interpretation-window strokes and hatching readable against the vivid field in dark mode and PNG exports.
- [x] Round chart fields to approximately 8px and preserve the light-theme grid and boundary colors across themes and exports.
