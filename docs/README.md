...
The [revised editorial packet](current-context-review-packet.md) records approved authoring direction and demo priority. The current draft bundle has 42 references, including 18 contemporary snapshots, and 14 re-curated recommendations. Individual factual/semantic review remains open. Source intake records scoped research for all required URLs; access and corpus review gates remain open.
