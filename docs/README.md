...
[Synthetic User Journeys](user-journeys.md) covers the development-only `/user-journeys` persona inspector, recorded paths/readiness, saved before/after comparisons, free regression reruns and explicit budgeted live Jev runs.
